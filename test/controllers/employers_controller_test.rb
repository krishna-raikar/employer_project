...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post employers_url, params: { employer: { age: @employer.age, email: @employer.email, gender: @employer.gender, name: @employer.name, password: @employer.password, reset_token: @employer.reset_token } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { age: @employer.age, email: @employer.email, gender: @employer.gender, name: @employer.name, password: @employer.password, reset_token: @employer.reset_token } }
